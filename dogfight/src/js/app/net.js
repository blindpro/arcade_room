 ...
 * id. The host's peer id is `dogfight-<code>` where <code> is the room
...
app.net = (() => {
  ...
  // Toggle in console: localStorage.dogfightNetDebug = '1' to see PeerJS
  ...
  const isDebug = () => {
    try { return window.localStorage && window.localStorage.dogfightNetDebug === '1' } catch (e) { return false }
  }
