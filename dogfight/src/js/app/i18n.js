app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'mp.subtitle': '2 to 6 players. Peer-to-peer over the internet. Host picks Free For All, Survival, or 2v2 Duel.',
      ...
      'mp.modeFfa': 'Free For All',
      'mp.modeSurvival': 'Survival (co-op)',
      'mp.modeTeamDm': '2v2 Duel',
      ...
      'ann.survivalRoundStartMp': 'Survival co-op. Survive together. Team kills count.',
      'ann.mpTeamStart': 'Round {round}. Your team versus the enemy team. Best of 3.',
      'ann.leaverForfeit': '{label} left the match.',
