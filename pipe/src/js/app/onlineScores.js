 ...
 *
 * REGISTERED as game id `pipe` (display_order: desc, max_score: 9999999,
 * meta_schema: [{"key":"bonus","type":"int","min":0,"max":9999999}]). See
...
app.onlineScores = (() => {
  ...
  const GAME_ID = 'pipe'
  const SECRET = 'pipe-placeholder-secret-not-registered-yet'
