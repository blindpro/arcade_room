...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'help.controlWeapon': '<kbd>1</kbd> / <kbd>2</kbd> / <kbd>3</kbd> — fire Pulse / Beam / Missile (each key auto-switches and shoots in one press, once that weapon is unlocked). <kbd>Space</kbd> fires the currently selected weapon; <kbd>Q</kbd> / <kbd>E</kbd> cycle the selection.',
      ...
      'help.tutorial1': 'Welcome to the audio tutorial. Listen — that soft engine hum you hear is your own ship, sitting dead centre. It pans with your aim, so it always tells you where you are pointing. Press Enter to continue.',
      ...
      'ann.bomberTutorial': 'Bombers inbound — low rumble with a bell strike. Press 2 to fire the Beam.',
      'ann.battleshipTutorial': 'Battleships inbound — heavy detuned drone. Press 3 to fire the Missile.',
    ...
    es: {
      ...
      'help.controlWeapon': '<kbd>1</kbd> / <kbd>2</kbd> / <kbd>3</kbd> — dispara Pulso / Rayo / Misil (cada tecla cambia el arma y dispara en una sola pulsación, cuando esa arma está desbloqueada). <kbd>Espacio</kbd> dispara el arma seleccionada; <kbd>Q</kbd> / <kbd>E</kbd> alternan la selección.',
      ...
      'help.tutorial1': 'Bienvenido al tutorial de audio. Escucha: ese motor suave que oyes es tu propia nave, plantada justo en el centro. Se mueve con el paneo de tu mira, así que siempre te indica dónde estás apuntando. Pulsa Intro para continuar.',
      ...
      'ann.bomberTutorial': 'Llegan Bombarderos — retumbo grave y campana. Pulsa 2 para disparar el Rayo.',
      'ann.battleshipTutorial': 'Llegan Acorazados — zumbido pesado y desafinado. Pulsa 3 para disparar el Misil.',
