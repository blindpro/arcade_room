 ...
 *
 * REGISTERED as game id `kombat` (display_order: desc, max_score: 9999999,
 * meta_schema: [{"key":"wave","type":"int","min":0,"max":999}]). See
...
app.onlineScores = (() => {
  ...
  const GAME_ID = 'kombat'
  const SECRET = 'kombat-placeholder-secret-not-registered-yet'
