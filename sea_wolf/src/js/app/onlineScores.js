 ...
 *
 * REGISTERED as game id `sea_wolf` (display_order: desc, max_score: 9999999,
 * meta_schema: [{"key":"sunk","type":"int","min":0,"max":999}]). See
...
app.onlineScores = (() => {
  ...
  const GAME_ID = 'sea_wolf'
  const SECRET = 'sea_wolf-placeholder-secret-not-registered-yet'
