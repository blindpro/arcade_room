...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'ann.status': '{tonnage} tons, {sunk} sunk. {torpedoes} torpedoes. Heading {heading}, speed {speed} knots, at {depth}. Hull {hull} percent, battery {battery} percent. {time} seconds left.',
    ...
    es: {
      ...
      'ann.status': '{tonnage} toneladas, {sunk} hundidos. {torpedoes} torpedos. Rumbo {heading}, velocidad {speed} nudos, a {depth}. Casco {hull} por ciento, bateria {battery} por ciento. Quedan {time} segundos.',
