...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'game.help': 'A fires left battery. S fires center battery. D fires right battery. Space also fires center. F1 score. F2 cities. F3 ammo. F4 wave. P pause. Escape pauses.',
      ...
      'help.goal': 'Six Spanish cities are under missile attack. Listen to the panning of each incoming missile, fire the correct battery, and bloom blast clouds in the path of every threat. Lose all six cities and the game ends. Survive to clear the wave; clear waves to climb the ranks.',
      'help.controlsHeader': 'Controls',
      'help.controlArrows': '<kbd>A</kbd> — fire left battery (missiles panning left). <kbd>S</kbd> or <kbd>Space</kbd> — fire center battery. <kbd>D</kbd> — fire right battery (missiles panning right).',
      'help.controlBatteries': 'Each battery fires straight up into its own zone. Listen to the panning of incoming threats to choose the right battery.',
      'help.controlSpace': '<kbd>Space</kbd> — fire center battery (alternative).',
      ...
      'help.audioLock': 'Each battery has a continuous <strong>lock tone</strong> that grows louder and begins to wobble as threats enter its zone. A full tremolo means the threat is close — fire now.',
      ...
      'help.tip4': 'When a battery\'s lock tone wobbles hard, fire — that threat is in the kill zone.',
      ...
      'learn.lockToneL': 'Lock tone — left battery (180 Hz)',
      'learn.lockToneC': 'Lock tone — center battery (240 Hz)',
      'learn.lockToneR': 'Lock tone — right battery (320 Hz)',
    ...
    es: {
      ...
      'game.help': 'A dispara izquierda. S dispara central. D dispara derecha. Espacio también dispara central. F1 puntos. F2 ciudades. F3 munición. F4 oleada. P pausar. Escape pausa.',
      ...
      'help.goal': 'Seis ciudades españolas están bajo ataque. Escucha la panorámica de cada misil entrante, dispara la batería correcta y haz estallar nubes de plasma en la trayectoria de cada amenaza. Si pierdes las seis ciudades, se acaba. Sobrevive para limpiar la oleada; limpia oleadas para subir de rango.',
      'help.controlsHeader': 'Controles',
      'help.controlArrows': '<kbd>A</kbd> — dispara batería izquierda (misiles que suenan a la izquierda). <kbd>S</kbd> o <kbd>Espacio</kbd> — dispara batería central. <kbd>D</kbd> — dispara batería derecha (misiles que suenan a la derecha).',
      'help.controlBatteries': 'Cada batería dispara verticalmente hacia su propia zona. Escucha la panorámica de las amenazas para elegir la batería correcta.',
      'help.controlSpace': '<kbd>Espacio</kbd> — dispara batería central (alternativa).',
      ...
      'help.audioLock': 'Cada batería tiene un <strong>tono de fijación</strong> continuo que se hace más fuerte y empieza a vibrar cuando hay amenazas en su zona. Si vibra del todo, dispara ahora.',
      ...
      'help.tip4': 'Cuando el tono de fijación de una batería vibra fuerte, dispara — esa amenaza está en la zona de eliminación.',
      ...
      'learn.cityZaragoza': 'Zaragoza (A3)',
      'learn.cityBilbao': 'Bilbao (C4)',
      'learn.lockToneL': 'Tono de fijación — batería izquierda (180 Hz)',
      'learn.lockToneC': 'Tono de fijación — batería central (240 Hz)',
      'learn.lockToneR': 'Tono de fijación — batería derecha (320 Hz)',
