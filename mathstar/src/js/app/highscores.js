// High score persistence. In Electron we write to a JSON file via the
// preload bridge; in HTML5 we fall back to localStorage. Up to 10 entries
// kept, sorted descending by score.
app.highscores = (() => {
  const KEY = 'mathstar-highscores-v1'
  const MAX = 10
