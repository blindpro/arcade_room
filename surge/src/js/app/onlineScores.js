 ...
 *
 * REGISTERED as game id `surge` (display_order: desc, max_score: 9999999,
 * meta_schema: [{"key":"distance","type":"int","min":0,"max":9999999}]). See
...
app.onlineScores = (() => {
  ...
  const GAME_ID = 'surge'
  const SECRET = 'surge-placeholder-secret-not-registered-yet'
