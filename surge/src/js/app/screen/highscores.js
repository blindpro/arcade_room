// SURGE highscores screen. Lists the local leaderboard and links to the online
// board. Entries store score + distance (saved as the `bonus` field by
// highscores.add).
  ...
  renderList: function () {
    ...
    list.forEach((entry, i) => {
      ...
      li.textContent = app.i18n.t('highscores.entry', {
        rank: i + 1, name: entry.name, score: entry.score, distance: entry.bonus || 0,
      })
      el.appendChild(li)
    })
  },
