...
function getContentJs() {
  const srcs = [
    'src/js/content.js',
    // Dependency order matters: these modules capture each other at
    // evaluation time, so load util first, then constants, meta, game,
    // audio and music. Later globs keep auto-picking up new files
    // (gulp dedupes the explicit entries above).
    'src/js/content/util.js',
    'src/js/content/constants.js',
    'src/js/content/meta.js',
    'src/js/content/game.js',
    'src/js/content/audio.js',
    'src/js/content/music.js',
    'src/js/content/*.js',
    'src/js/content/**/*.js',
  ]
