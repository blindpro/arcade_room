...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'menu.survival': 'Survival — survive endless waves',
      ...
      'setup.subtitleSurvival': 'Choose how many starting opponents. When you eliminate one, a new challenger enters the arena. Power-ups are available to help you survive.',
      ...
      'game.instructions': 'Arrow keys drive. Q is a targeting sweep of opponents. Space honks the horn. In arcade and deathmatch, W sweeps pickups, A S D fire bullets, E cycles through your items, Tab uses the selected item, and F3 reads your inventory. F6 reads the time remaining in deathmatch. Press Escape to pause.',
      'game.health': 'Health: ',
      'game.score': 'Score: ',
      'game.cars': 'Cars left: ',
      ...
      'game.cantRepulsor': 'Cannot use repulsor right now.',
      'game.noRepulsors': 'No repulsors.',
      'game.rocketNotReady': 'Rocket still active.',
      'game.noRockets': 'No rockets.',
      'game.noItems': 'No items available.',
      'game.noItemSelected': 'No item selected. Press E to cycle.',
      ...
      'gameOver.resultLoseSurvival': 'You eliminated {kills} opponents.',
      ...
      'help.pickupMine': '<strong>Trap mine</strong> — subtle ticking. Cycle to it with <kbd>E</kbd>, then press <kbd>Tab</kbd> to drop one behind you. Persists until something runs into it.',
      'help.pickupSpeed': '<strong>Speed burst</strong> — fast revving whir. Cycle to it with <kbd>E</kbd>, then press <kbd>Tab</kbd> to use one. Doubles your top speed and acceleration for 4 seconds — perfect for chasing down or ramming someone.',
      'help.pickupTeleport': '<strong>Teleport</strong> — shimmering high warble. Cycle to it with <kbd>E</kbd>, then press <kbd>Tab</kbd> to use one. Snaps you to a random open spot in the arena, well clear of any wall — handy for breaking out of a corner trap.',
      'help.pickupRepulsor': '<strong>Repulsor blast</strong> — deep pulsing throb. Cycle to it with <kbd>E</kbd>, then press <kbd>Tab</kbd> to use one. Pushes every nearby car away from you and deals 15 damage to each — great for escaping a pile-up or softening up a cluster of opponents.',
      'help.pickupRocket': '<strong>Rocket boost</strong> — aggressive high-energy whine. Cycle to it with <kbd>E</kbd>, then press <kbd>Tab</kbd> to use one. Launches you forward at extreme speed for 1.2 seconds; any car you hit during the rocket takes 5 times the normal collision damage. Lining up a ram while rocketing is devastating.',
      ...
      'help.hotkeyE': '<kbd>E</kbd> — cycle forward to the next item with charges',
      'help.hotkeyTab': '<kbd>Tab</kbd> — use the currently selected item',
      ...
      'learn.pickupRepulsor': 'Arcade — repulsor pickup',
      'learn.pickupRocket': 'Arcade — rocket pickup',
      'learn.repulsorActivated': 'Arcade — repulsor blast activated',
      'learn.rocketActivated': 'Arcade — rocket boost activated',
      'learn.rocketExpired': 'Arcade — rocket boost ends',
      ...
      'ann.youKilledBySurvival': 'Game over. You eliminated {kills} opponents.',
      ...
      'ann.survivalEnter': '{label} has entered the arena!',
      'ann.survivalKillCount': '{kills} kills.',
      ...
      'ann.survivalRoundStart1': 'Survival! 1 opponent. Power-ups are available. Survive as long as you can. Go.',
      'ann.survivalRoundStartN': 'Survival! {count} opponents. Power-ups are available. Survive as long as you can. Go.',
      ...
      'ann.boostUseYou': 'Boost! Four seconds.',
      ...
      'ann.itemSelected': '{item}: {count} ready.',
      'ann.teleportUseYou': 'Teleport! New position.',
      'ann.teleportUseOther': '{label} teleports away.',
      'ann.repulsorYou1': 'Repulsor. 1 repulsor ready.',
      'ann.repulsorYouN': 'Repulsor. {count} repulsors ready.',
      'ann.repulsorOther': '{label} picks up a repulsor. Has {count}.',
      'ann.repulsorUseYou': 'Repulsor blast! Nearby cars pushed away.',
      'ann.repulsorUseOther': '{label} fires a repulsor blast!',
      'ann.rocketYou1': 'Rocket. 1 rocket ready.',
      'ann.rocketYouN': 'Rocket. {count} rockets ready.',
      'ann.rocketOther': '{label} picks up a rocket. Has {count}.',
      'ann.rocketUseYou': 'Rocket boost! One point two seconds.',
      'ann.rocketUseOther': '{label} launches a rocket!',
      'ann.repulsorsPart1': '1 repulsor',
      'ann.repulsorsPartN': '{count} repulsors',
      'ann.rocketsPart1': '1 rocket',
      'ann.rocketsPartN': '{count} rockets',
      'ann.arenaMap': 'Arena: {name}.',
      ...
      'pickup.boost': 'speed burst',
      'pickup.repulsor': 'repulsor',
      'pickup.rocket': 'rocket',
    ...
    es: {
      ...
      'menu.survival': 'Supervivencia — sobrevive oleadas infinitas',
      ...
      'setup.titleArcade': 'Arcade',
      'setup.titleSurvival': 'Supervivencia',
      'setup.subtitleSurvival': 'Elige cuántos rivales iniciales. Al eliminar uno, un nuevo retador entra en la arena. Hay potenciadores disponibles para ayudarte a sobrevivir.',
      ...
      'game.cantRepulsor': 'No puedes usar el repulsor ahora.',
      'game.noRepulsors': 'Sin repulsores.',
      'game.rocketNotReady': 'El cohete sigue activo.',
      'game.noRockets': 'Sin cohetes.',
      'game.noItems': 'No hay objetos disponibles.',
      'game.noItemSelected': 'Ningún objeto seleccionado. Pulsa E para ciclar.',
      ...
      'gameOver.resultLoseSurvival': 'Eliminaste a {kills} rivales.',
      ...
      'gameOver.summarySurvival': 'Juego terminado. {kills} eliminaciones. Récord personal {best}.',
      ...
      'help.pickupMine': '<strong>Mina trampa</strong> — tictac sutil. cíclala con <kbd>E</kbd> y pulsa <kbd>Tab</kbd> para soltar una detrás. Permanece hasta que algo pasa por encima.',
      'help.pickupSpeed': '<strong>Turbo</strong> — zumbido acelerado. Cíclalo con <kbd>E</kbd> y pulsa <kbd>Tab</kbd> para usar uno. Duplica tu velocidad punta y aceleración durante 4 segundos — ideal para perseguir o embestir.',
      'help.pickupTeleport': '<strong>Teletransporte</strong> — trino agudo brillante. Cíclalo con <kbd>E</kbd> y pulsa <kbd>Tab</kbd> para usar uno. Te lleva a un punto despejado al azar de la arena, lejos de las paredes — útil para salir de una trampa en una esquina.',
      'help.pickupRepulsor': '<strong>Pulso repulsor</strong> — pulso grave y profundo. Cíclalo con <kbd>E</kbd> y pulsa <kbd>Tab</kbd> para usar uno. Empuja todos los coches cercanos lejos de ti y causa 15 de daño a cada uno — ideal para escapar de un grupo o debilitar a varios rivales.',
      'help.pickupRocket': '<strong>Cohete impulsor</strong> — zumbido agresivo de alta energía. Cíclalo con <kbd>E</kbd> y pulsa <kbd>Tab</kbd> para usar uno. Te lanza hacia delante a velocidad extrema durante 1,2 segundos; cualquier coche que golpees durante el cohete recibe 5 veces el daño de colisión normal. Apuntar un embestida con cohete es devastador.',
      ...
      'help.hotkeyE': '<kbd>E</kbd> — cicla al siguiente objeto con carga',
      'help.hotkeyTab': '<kbd>Tab</kbd> — usa el objeto seleccionado',
      ...
      'ann.youKilledBySurvival': 'Juego terminado. Eliminaste a {kills} rivales.',
      ...
      'ann.survivalEnter': '¡{label} ha entrado en la arena!',
      'ann.survivalKillCount': '{kills} eliminaciones.',
      ...
      'ann.survivalRoundStart1': '¡Supervivencia! 1 rival. Hay potenciadores disponibles. Sobrevive todo lo que puedas. ¡Vamos!',
      'ann.survivalRoundStartN': '¡Supervivencia! {count} rivales. Hay potenciadores disponibles. Sobrevive todo lo que puedas. ¡Vamos!',
      ...
      'ann.boostUseYou': '¡Turbo! Cuatro segundos.',
      ...
      'ann.itemSelected': '{item}: {count} listo.',
      'ann.teleportUseYou': '¡Teletransporte! Nueva posición.',
      'ann.teleportUseOther': '{label} se teletransporta.',
      'ann.repulsorYou1': 'Repulsor. 1 repulsor listo.',
      'ann.repulsorYouN': 'Repulsor. {count} repulsores listos.',
      'ann.repulsorOther': '{label} recoge un repulsor. Tiene {count}.',
      'ann.repulsorUseYou': '¡Pulso repulsor! Coches cercanos empujados.',
      'ann.repulsorUseOther': '¡{label} dispara un pulso repulsor!',
      'ann.rocketYou1': 'Cohete. 1 cohete listo.',
      'ann.rocketYouN': 'Cohete. {count} cohetes listos.',
      'ann.rocketOther': '{label} recoge un cohete. Tiene {count}.',
      'ann.rocketUseYou': '¡Cohete impulsor! Un segundo y dos décimas.',
      'ann.rocketUseOther': '¡{label} lanza un cohete!',
      'ann.repulsorsPart1': '1 repulsor',
      'ann.repulsorsPartN': '{count} repulsores',
      'ann.rocketsPart1': '1 cohete',
      'ann.rocketsPartN': '{count} cohetes',
      'ann.arenaMap': 'Arena: {name}.',
